...
jQuery(document).ready(function() {
	jQuery('.upcp-upload-style-button').on('click', function() {
...
jQuery(document).ready(function($) {
	jQuery('.ewd-upcp-admin-option-toggle').on('change', function() {
		...
		if (jQuery(this).is(':checked')) {
			...
			jQuery('input[name="' + Input_Name + '"][value="No"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="yes"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="no"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="Yoast"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="None"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="gradient"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="gradient-none"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="shadow"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="shadow-none"]').prop('checked', false).trigger('change');
		}
		else {
			jQuery('input[name="' + Input_Name + '"][value="Yes"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="No"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="yes"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="no"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="Yoast"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="None"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="gradient"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="gradient-none"]').prop('checked', true).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="shadow"]').prop('checked', false).trigger('change');
			jQuery('input[name="' + Input_Name + '"][value="shadow-none"]').prop('checked', true).trigger('change');
		}
	});
	$(function(){
		$(window).resize(function(){
...
jQuery(document).ready(function($){
	...
	$('input[data-inputname="seo_option"]').click( function() {
		if ( jQuery( this ).prop( 'checked' ) ) {
			jQuery('#ewd-upcp-admin-yoast-description-handling').show();
		}
		else {
			jQuery('#ewd-upcp-admin-yoast-description-handling').hide();
		}
	});
	$('input[data-inputname="woocommerce_sync"]').click( function() { 
		if ( jQuery( this ).prop( 'checked' )){
			jQuery('.ewd-upcp-admin-conditional-wc-options').show();
		}
		else{
			jQuery('.ewd-upcp-admin-conditional-wc-options').hide();
		}
	});
});
