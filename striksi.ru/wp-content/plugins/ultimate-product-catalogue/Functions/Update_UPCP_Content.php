	...
	if (isset($_GET['Action'])) {
		switch ($_GET['Action']) {
			...
			case "UPCP_Duplicate_Product":
				$upcp_message = Duplicate_UPCP_Product( intval( $_GET['Item_ID'] ) );
				break;
			case "UPCP_DeleteProduct":
					$upcp_message = Delete_UPCP_Product( intval( $_GET['Item_ID'] ) );
					break;
			...
			case "UPCP_DeleteProductVideo":
					$upcp_message = Delete_Product_Video( intval( $_GET['Item_Video_ID'] ) );
					break;
			...
			case "UPCP_DeleteOptionalImage":
					$upcp_message = Delete_Optional_Image( intval( $_GET['Item_Optional_Image_ID'] ) );
					break;
			...
			case "UPCP_DeleteCategory":
					$upcp_message = Delete_UPCP_Category( intval( $_GET['Category_ID'] ) );
					break;
			...
			case "UPCP_DeleteCatalogue":
					$upcp_message = Delete_UPCP_Catalogue( intval( $_GET['Catalogue_ID'] ) );
					break;
			...
			case "UPCP_DeleteCatalogueItem":
					$upcp_message = Delete_Catalogue_Item( intval( $_GET['Catalogue_Item_ID'] ) );
					break;
			...
			case "UPCP_DeleteSubCategory":
					$upcp_message = Delete_UPCP_SubCategory( intval( $_GET['SubCategory_ID'] ) );
					break;
			...
			case "UPCP_AddTag":
					...
					break;
			case "UPCP_DeleteTag":
					$upcp_message = Delete_UPCP_Tag( intval( $_GET['Tag_ID'] ) );
					break;
			...
			case "UPCP_DeleteTagGroup":
					$upcp_message = Delete_UPCP_Tag_Group( intval( $_GET['Tag_Group_ID'] ) );
					break;
			...
			case "UPCP_DeleteCustomField":
					$upcp_message = Delete_UPCP_Custom_Field( intval( $_GET['Field_ID'] ) );
					break;
