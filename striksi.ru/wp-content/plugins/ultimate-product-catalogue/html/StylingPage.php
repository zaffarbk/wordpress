<?php
	...
	if (isset($_POST['Styles_Display_Tab'])) {$Display_Tab = sanitize_text_field( $_POST['Styles_Display_Tab'] );}
	else {$Display_Tab = "";} 
?>
...
<input type='hidden' name='Styles_Display_Tab' value='<?php echo esc_attr( $Display_Tab ); ?>' />
