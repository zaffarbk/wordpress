<?php $Tag = $wpdb->get_row( $wpdb->prepare( "SELECT * FROM $tags_table_name WHERE Tag_ID ='%d'", intval( $_GET['Tag_ID'] ) ) ); ?>
		...
		<div class="OptionTab ActiveTab" id="EditTag">
				...
				<?php $Tagged_Items = $wpdb->get_results( $wpdb->prepare( "SELECT Item_ID FROM $tagged_items_table_name WHERE Tag_ID='%d'", intval( $_GET['Tag_ID'] ) ) );
				...
				<div class="form-wrap TagDetail">
						...
						<input type="hidden" name="Tag_ID" value="<?php echo esc_attr( $Tag->Tag_ID ); ?>" />
						<input type="hidden" name="WC_term_id" value="<?php echo esc_attr( $Tag->Tag_WC_ID ); ?>" />
						...
						<div class='form-field'>
								...
								<input name="Tag_Name" id="Tag_Name" type="text" value="<?php echo esc_attr( $Tag->Tag_Name );?>" size="60" />
						...
						<div class='form-field'>
								...
								<textarea name="Tag_Description" id="Tag_Description" rows="5" cols="40"><?php echo esc_html( $Tag->Tag_Description );?></textarea>
